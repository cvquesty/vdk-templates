...
# # fetch config from current VDK.  Assume it's in the same directory as this repo.
# FileUtils.cp(File.join('..', '..', 'vdk', '.rubocop.yml'), '.')
...
# report_cops(configured_cops, "the vdk config")
